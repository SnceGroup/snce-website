...
$oldSetArray_c0c77bcd70fc14903ba64f0c0d07ba9e = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form id="menu-form-create-here" method="post" action="/ezdemo_site_clean_admin/content/action">
...
$setArray = $oldSetArray_c0c77bcd70fc14903ba64f0c0d07ba9e;
$tpl->Level--;
?>
