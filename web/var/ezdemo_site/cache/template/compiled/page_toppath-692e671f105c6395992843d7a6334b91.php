...
$oldSetArray_2fca90557c4b3047469288946bc99aa0 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<p class="path"><span class="path-here-text">Sei qui:</span>';
unset( $loopItem );
unset( $loopItem );
...
$setArray = $oldSetArray_2fca90557c4b3047469288946bc99aa0;
$tpl->Level--;
?>
