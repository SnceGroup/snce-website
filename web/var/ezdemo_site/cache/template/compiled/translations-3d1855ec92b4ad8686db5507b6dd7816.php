...
$oldSetArray_bb553e59ce6983f99164f9190be8a64d = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<form name="translationsform" method="post" action="/ezdemo_site_clean_admin/content/translation">
...
<fieldset>
<legend>Traduzioni esistenti</legend>

<table id="tab-translations-list" class="list" cellspacing="0" summary="Elenco delle traduzioni per il nodo attuale.">
<tr>
    <th class="tight"><img src="/design/admin/images/toggle-button-16x16.gif" width="16" height="16" alt="Inverti selezione." title="Inverti selezione." onclick="ezjs_toggleCheckboxes( document.translationsform, \'LanguageID[]\' ); return false;"/></th>
    <th>Lingua</th>
...
$text .= '" title="Usa questi pulsanti radio per selezionare la lingua principale prescelta." />
';
}
unset( $if_cond );
// if ends
...
$text .= '><img src="/extension/ezdemo/design/ezdemo/images/edit.gif" width="16" height="16" alt="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$var1 = strtr( 'Modifica in <%language_name>.', $var4 );
...
if ( $if_cond )
{
$text .= '    <input class="button" type="submit" name="RemoveTranslationButton" value="Elimina selezionati" title="Elimina le lingue selezionate dall\'elenco in alto." />
    ';
}
else
{
$text .= '    <input class="button-disabled" type="submit" name="RemoveTranslationButton" value="Elimina selezionati" title="Non ci sono lingue da rimuovere." disabled="disabled" />
    ';
}
unset( $if_cond );
// if ends
...
{
$text .= '    <input class="button-disabled" type="submit" name="RemoveTranslationButton" value="Elimina selezionati" disabled="disabled" title="Non puoi eliminare nessuna lingua perché non sei abilitato a modificare l\'oggetto corrente." />';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    <input id="tab-translations-list-set-main" class="button" type="submit" name="UpdateInitialLanguageButton" value="Imposta principale" title="Selezionare la lingua principale prescelta usando questi pulsanti radio e premi questo pulsante per registrare la configurazione." />
...
{
$text .= '    <input class="button-disabled" type="submit" name="UpdateInitialLanguageButton" value="Imposta principale" disabled="disabled" title="Non puoi cambiare la lingua principale perché l\'oggetto non è tradotto in nessun\'altra lingua." />
    ';
}
unset( $if_cond );
// if ends
...
{
$text .= '    <input class="button-disabled" type="submit" name="UpdateInitialLanguageButton" value="Imposta principale" disabled="disabled" title="Non puoi cambiare la lingua principale perché non sei abilitato a modificare l\'oggetto corrente." />';
}
unset( $if_cond );
// if ends
...
$text .= ' /> Usa la lingua principale se non ci sono traduzioni prioritarie.
</div>
...
if ( $if_cond )
{
$text .= '    <input id="tab-translations-alwaysavailable-btn" class="button" type="submit" name="UpdateAlwaysAvailableButton" value="Aggiorna" title="Usa questo pulsante per registrare il valore del checkbox in alto." />
    <script type="text/javascript">
...
{
$text .= '    <input class="button-disabled" disabled="disabled" type="submit" name="UpdateAlwaysAvailableButton" value="Aggiorna" title="Non sei abilitato a modificare quest\'impostazione." />';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_bb553e59ce6983f99164f9190be8a64d;
$tpl->Level--;
?>
