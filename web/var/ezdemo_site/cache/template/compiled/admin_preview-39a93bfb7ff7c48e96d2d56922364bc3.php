<?php
// URI:       design/admin/templates/node/view/admin_preview.tpl
// Filename:  design/admin/templates/node/view/admin_preview.tpl
// Timestamp: 1383940876 (Fri Nov 8 21:01:16 CET 2013)
$oldSetArray_95ab6e6e6c5bf94ada38528476e936e8 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $loopItem );
unset( $loopItem );
$loopItem = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'node', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['node'] : null;
$loopItem1 = compiledFetchAttribute( $loopItem, 'object' );
unset( $loopItem );
$loopItem = $loopItem1;
$loopItem1 = compiledFetchAttribute( $loopItem, 'contentobject_attributes' );
unset( $loopItem );
$loopItem = $loopItem1;
...
unset( $if_cond );
$if_cond = $if_cond1;
$if_cond1 = compiledFetchAttribute( $if_cond, 'view' );
unset( $if_cond );
$if_cond = $if_cond1;
...
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'contentclass_attribute' );
unset( $var1 );
$var1 = $var2;
...
if ( $if_cond )
{
$text .= ' <span class="collector">(raccoglitore informazioni)</span>';
}
unset( $if_cond );
// if ends
...
$tpl->processFunction( 'attribute_view_gui', $textElements,
  ...
  2 => 'design/admin/templates/node/view/admin_preview.tpl',
),
...
$setArray = $oldSetArray_95ab6e6e6c5bf94ada38528476e936e8;
$tpl->Level--;
?>
