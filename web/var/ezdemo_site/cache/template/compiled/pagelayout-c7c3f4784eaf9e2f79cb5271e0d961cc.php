...
if ( $if_cond )
{
$text .= '    <a id="rightmenu-showhide" class="show-hide-control" title="Mostra / nascondi il menù di destra" href="/ezdemo_site_clean_admin/user/preferences/set/admin_right_menu_show/1"></a>
    <div id="rightmenu-design"></div>';
}
else
{
$text .= '    <a id="rightmenu-showhide" class="show-hide-control" title="Nascondi / Mostra il menù di destra" href="/ezdemo_site_clean_admin/user/preferences/set/admin_right_menu_show/0"></a>
