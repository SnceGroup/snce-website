...
$oldSetArray_b375615a456c9ad57615a4735391608e = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
{
    $vars[$currentNamespace]['left_max'] = 7;
...
switch ( $match )
{
    case 0:
    {
$text .= '      <span class="previous"><a href=';
unset( $var );
unset( $var1 );
unset( $var2 );
unset( $var2 );
...
$text .= '><span class="text">&laquo;&nbsp;Precedente</span></a></span>
       ';
    } break;
    default:
    {
$text .= '      <span class="previous"><span class="text disabled">&laquo;&nbsp;Precedente</span></span>
       ';
    } break;
}
unset( $match );
...
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $currentNamespace, $vars ) and array_key_exists( 'item_next', $vars[$currentNamespace] ) ) ? $vars[$currentNamespace]['item_next'] : null;
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
    $var1 = $var1->templateValue();
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
...
unset( $var2 );
unset( $var2 );
$var2 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'item_count', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['item_count'] : null;
if (! isset( $var2 ) ) $var2 = NULL;
while ( is_object( $var2 ) and method_exists( $var2, 'templateValue' ) )
    $var2 = $var2->templateValue();
while ( is_object( $var2 ) and method_exists( $var2, 'templateValue' ) )
...
unset( $match1 );
unset( $match1 );
$match1 = ( array_key_exists( $currentNamespace, $vars ) and array_key_exists( 'item_next', $vars[$currentNamespace] ) ) ? $vars[$currentNamespace]['item_next'] : null;
if (! isset( $match1 ) ) $match1 = NULL;
while ( is_object( $match1 ) and method_exists( $match1, 'templateValue' ) )
    $match1 = $match1->templateValue();
while ( is_object( $match1 ) and method_exists( $match1, 'templateValue' ) )
...
unset( $match2 );
unset( $match2 );
$match2 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'item_count', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['item_count'] : null;
...
$text .= '><span class="text">Successivo&nbsp;&raquo;</span></a></span>
      ';
    } break;
    default:
    {
$text .= '        <span class="next"><span class="text disabled">Successivo&nbsp;&raquo;</span></span>
      ';
    } break;
}
unset( $match );
...
$setArray = $oldSetArray_b375615a456c9ad57615a4735391608e;
$tpl->Level--;
?>
