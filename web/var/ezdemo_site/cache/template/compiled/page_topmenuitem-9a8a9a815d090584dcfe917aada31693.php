<?php
// URI:       design/admin/templates/page_topmenuitem.tpl
// Filename:  design/admin/templates/page_topmenuitem.tpl
// Timestamp: 1383940876 (Fri Nov 8 21:01:16 CET 2013)
$oldSetArray_a09bd1c62b35ec68c6ee0b51a6597962 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'liclass', $rootNamespace ) )
{
  ...
  2 => 'design/admin/templates/page_topmenuitem.tpl',
) );
...
unset( $if_cond1 );
unset( $if_cond1 );
$if_cond1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'navigationpart_identifier', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['navigationpart_identifier'] : null;
...
{
    $vars[$currentNamespace]['liclass'] = 'selected ';
}
}
unset( $if_cond );
// if ends
...
{
$text .= '    <span class="disabled" title="';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'menu_item', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['menu_item'] : null;
$var1 = compiledFetchAttribute( $var, 'tooltip' );
...
$setArray = $oldSetArray_a09bd1c62b35ec68c6ee0b51a6597962;
$tpl->Level--;
?>
